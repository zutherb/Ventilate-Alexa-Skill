...
import ventilate.speechlet.VentilateSpeechlet;
...
public final class Launcher {
    ...
    public static void main(final String[] args) throws Exception {
        ...
        VentilateSpeechlet ventilateSpeechlet = new VentilateSpeechlet();
        
        context.addServlet(new ServletHolder(createServlet(ventilateSpeechlet)), "/ventilate");
